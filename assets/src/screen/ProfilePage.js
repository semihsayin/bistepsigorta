            ...
            <View style={styles.container}>
                ...
                <View style={styles.profile}>
                    <View style={styles.profileName}>
                        ...
                        <Text style={{fontSize:Height*0.028,fontWeight:'700',fontFamily: 'Poppins-Medium'}}>Bi Adim</Text>
                        ...
                        <View style={{flex:0.6,flexDirection:'row'}}>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <Text style={{color:'white',fontSize:Height*0.028,fontWeight:'600',fontFamily: 'Poppins-Medium'}}>Follow</Text>
                                </ImageBackground>
                    ...
                    <View style={styles.dataProfile}>
                        <View style={styles.dataSet}>
                            ...
                            <View style={styles.dataText}>
                                <View style={{flexDirection:'row'}}>
                                    <Text style={{fontWeight:'700',fontSize:Height*0.023,fontFamily: 'Poppins-Medium'}}>6125555</Text>

                                </View>



                                <Text style={{marginLeft:4,marginTop:7,fontSize:Height*0.0168,color:'#bdbdbd',fontFamily: 'Poppins-Medium'}}>Adim Sayisi</Text>
                            </View>
                        ...
                        <View style={styles.dataSet}>
                            ...
                            <View style={styles.dataText}>
                                <View style={{flexDirection:'row'}}>
                                    <Text style={{fontWeight:'700',fontSize:Height*0.023,fontFamily: 'Poppins-Medium'}}>6500</Text>
                                    <Text style={{fontSize:Height*0.0168,marginTop:Height*0.0056,marginLeft:Height*0.0056,fontWeight:'500',fontFamily: 'Poppins-Medium'}}>Km</Text>
                                </View>
                        ...
                        <View style={styles.dataSetLast}>
                            ...
                            <View style={styles.dataTextLast}>
                                <View style={{flexDirection:'row'}}>
                                    <Text style={{fontWeight:'700',fontSize:Height*0.023,fontFamily: 'Poppins-Medium'}}>3400</Text>
                                    <Text style={{fontSize:Height*0.0168,marginLeft:Height*0.0042,marginTop:Height*0.0056,fontWeight:'500',fontFamily: 'Poppins-Medium'}}>Cal</Text>
                                </View>
                    ...
                    <View style={styles.rozetler}>
                        ...
                        <View style={{flexDirection:'row'}}>
                            <Text style={{marginTop:10,marginLeft:20,fontWeight:'500',fontSize:Height*0.0252,fontFamily: 'Poppins-Medium'}}>Kazanilan Basarilar</Text>
                            <View style={{flex:0.9}}/>

                            <Text style={{marginTop:10,color:'#667ad5',fontFamily: 'Poppins-Medium'}}>daha fazla</Text>
                    ...
                    <View style={styles.challange}>
                        <Text style={{marginTop:Height*0.014,marginLeft:Height*0.028,fontSize:Height*0.025,fontWeight:'500',fontFamily: 'Poppins-Medium'}}>1-1 Challange</Text>
